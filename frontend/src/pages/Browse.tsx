    ...
    return (
        ...
        >
            ...
            >
                {toast && (
                    <div
                        className={`flex items-center gap-3 rounded-2xl px-8 py-4 text-sm font-bold shadow-2xl ${toastStyles[toast.type]}`}
                        style={{ fontFamily: "'Space Mono', monospace" }}
                    >
            ...
            <main className="w-full flex flex-col items-center px-4 sm:px-6 pb-10 pt-6 relative z-10">
                ...
                <div className="mb-6 w-full max-w-2xl flex items-center justify-between">
                    ...
                    {/* Counter badge */}
                    <div
                        className="flex items-center gap-2 rounded-2xl bg-[#1D1829] border border-[#2E2640] px-5 py-3"
                        style={{ fontFamily: "'Space Mono', monospace" }}
                    >
                ...
                {!profile ? (
                    <div className="w-full max-w-2xl rounded-[28px] bg-[#1D1829] border border-[#2E2640] shadow-2xl shadow-black/60 p-16 text-center">
                        ...
                        <a
                            href="/matches"
                            className="inline-flex items-center gap-2 rounded-2xl bg-[#C8FF4D] px-8 py-4 text-sm font-bold text-[#15111F] hover:shadow-[0_0_30px_4px_rgba(200,255,77,0.35)] hover:-translate-y-0.5 transition-all duration-200"
                        >
                            See your matches →
                        </a>
                    </div>
                    ...
                    <div className="w-full max-w-2xl">
                        ...
                        {/* Hint pill */}
                        <div
                            className="mb-5 w-fit mx-auto flex items-center gap-3 rounded-full bg-[#1D1829] border border-[#2E2640] px-5 py-2 text-xs text-[#9D93B8]"
                            style={{ fontFamily: "'Space Mono', monospace" }}
                        >
                            <span>👈 Pass</span>
                                ...
                                <div className="px-7 pt-5 pb-4 space-y-4">
                                    ...
                                    <div className="flex items-start justify-between gap-4">
                                            ...
                                            <div className="mt-2 flex items-center gap-2 flex-wrap">
                                                ...
                                                {profile.occupation && (
                                                    <>
                                                        ...
                                                        <span
                                                            className="rounded-full bg-[#2A2438] border border-[#3A324D] px-3 py-1 text-xs font-semibold text-[#C8FF4D]"
                                                            style={{ fontFamily: "'Space Mono', monospace" }}
                                                        >
                                                            {profile.occupation}
                                                        </span>
                                        ...
                                        <div className="text-right flex-shrink-0">
                                            ...
                                            <p className="text-lg font-bold text-[#C8FF4D]">
                        ...
                        <div className="mt-6 flex items-center justify-center gap-5 rounded-2xl bg-[#1D1829] border border-[#2E2640] px-6 py-3">
                            ...
                            <span
                                className="text-sm font-bold text-[#F4F1FF] min-w-[64px] text-center"
                                style={{ fontFamily: "'Space Mono', monospace" }}
                            >
                                {current + 1}{" "}
                                <span className="text-[#6E6585] font-normal">of</span>{" "}
                                {profiles.length}
                            </span>
