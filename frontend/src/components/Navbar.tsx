...
export default function Navbar() {
    ...
    return (
        <nav className="bg-white border-b px-6 py-3 flex items-center justify-between">
            <Link to="/browse" className="text-xl font-bold text-orange-500">.findOne()</Link>
            <div className="flex items-center gap-6 text-sm">
                <Link to="/browse" className="text-gray-500 hover:text-orange-500 transition">Browse</Link>
